/* eslint-disable no-param-reassign,react/prop-types,no-unused-expressions,jsx-a11y/no-noninteractive-element-interactions,react/jsx-no-bind,jsx-a11y/label-has-for,jsx-a11y/no-static-element-interactions,react/forbid-prop-types,react/forbid-prop-types,react/require-default-props */
...
export default class InfinityMenu extends React.Component {
  ...
  setDisplayTree(tree, prevs, curr, keyPath) {
    ...
    const currCustomloadMoreComponent = this.props.loadMoreComponent
 ...
 */
  ...
  renderBody(displayTree) {
    const { emptyTreeComponent, emptyTreeComponentProps } = this.props;
  ...
  render() {
    ...
    const filteredTree =
      this.state.search.isSearching && this.state.search.searchInput
    ...
    const defaultHeaderContent = this.props.disableDefaultHeaderContent
      ? null
      : React.createElement(SearchInput, headerProps);
    const headerContent = this.props.headerContent
      ? React.createElement(this.props.headerContent, headerProps)
